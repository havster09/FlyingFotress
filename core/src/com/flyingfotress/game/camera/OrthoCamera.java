package com.flyingfotress.game.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(FlyingFotress.WIDTH, FlyingFotress.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(FlyingFotress.WIDTH, FlyingFotress.HEIGHT);
